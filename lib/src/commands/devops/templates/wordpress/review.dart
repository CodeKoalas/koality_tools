...
deployment:
  ...
  extraEnv:
    SITE_ENV: stage
    WP_HOME: "https://[SITE NAME]-review.ckstage.site"
    WP_SITEURL: "https://[SITE NAME]-review.ckstage.site/"
    WP_DEBUG: "true"
...
persistence:
  ...
  volumes:
    - name: data
      mount:
        mountPath: /var/www/html/docroot/wp-content/uploads
