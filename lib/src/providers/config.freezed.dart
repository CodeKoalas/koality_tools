...
/// @nodoc
abstract class _$$KoalityConfigImplCopyWith<$Res>
    implements $KoalityConfigCopyWith<$Res> {
  factory _$$KoalityConfigImplCopyWith(
          _$KoalityConfigImpl value, $Res Function(_$KoalityConfigImpl) then) =
...
/// @nodoc
class __$$KoalityConfigImplCopyWithImpl<$Res>
    extends _$KoalityConfigCopyWithImpl<$Res, _$KoalityConfigImpl>
    implements _$$KoalityConfigImplCopyWith<$Res> {
  __$$KoalityConfigImplCopyWithImpl(
      _$KoalityConfigImpl _value, $Res Function(_$KoalityConfigImpl) _then)
      : super(_value, _then);
...
class _$KoalityConfigImpl extends _KoalityConfig {
  ...
  factory _$KoalityConfigImpl.fromJson(Map<String, dynamic> json) =>
      _$$KoalityConfigImplFromJson(json);
...
/// @nodoc
abstract class _$$KubectlConfigImplCopyWith<$Res>
    implements $KubectlConfigCopyWith<$Res> {
  factory _$$KubectlConfigImplCopyWith(
          _$KubectlConfigImpl value, $Res Function(_$KubectlConfigImpl) then) =
...
/// @nodoc
class __$$KubectlConfigImplCopyWithImpl<$Res>
    extends _$KubectlConfigCopyWithImpl<$Res, _$KubectlConfigImpl>
    implements _$$KubectlConfigImplCopyWith<$Res> {
  __$$KubectlConfigImplCopyWithImpl(
      _$KubectlConfigImpl _value, $Res Function(_$KubectlConfigImpl) _then)
      : super(_value, _then);
...
class _$KubectlConfigImpl extends _KubectlConfig {
  const _$KubectlConfigImpl({this.defaultNamespace = 'gitlab-managed-apps'})
      : super._();

  factory _$KubectlConfigImpl.fromJson(Map<String, dynamic> json) =>
      _$$KubectlConfigImplFromJson(json);
...
class _$FirebaseConfigImpl extends _FirebaseConfig {
  const _$FirebaseConfigImpl({this.skipDev = false, this.skipProd = false})
      : super._();
