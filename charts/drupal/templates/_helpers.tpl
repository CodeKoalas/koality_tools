...
{{- define "trackabledbname" -}}
{{- $trackableDbName := printf "%s-%s-db" (include "appname" .) .Values.application.track -}}
...
{{/*
Get SecRule arguments with unescaped single&double quotes
*/}}
{{- define "secrule" -}}
...
{{/*
Create the name of the cluster issuer secret
*/}}
{{- define "clusterIssuerSecretName" -}}
{{ default "letsencrypt-prod" .Values.clusterIssuerSecretName }}
{{- end -}}
